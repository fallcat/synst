...
from data.iwslt import IWSLTDataset, IWSLTEnViDataset
...
DATASETS = {
    ...
    for _dataset in (WMTEnDeDataset, WMTEnFrDataset, WMTEnFrFullDataset, IWSLTDataset,PETITEEnFrDataset, PETITEEnRoDataset, PETITEEnJpDataset, IWSLTEnViDataset)
