...
def add_new_transformer_args(parser):
    ...
    group.add_argument(
        '--layermask-type',
        type=str,
        choices=['noskip', 'itertrain', 'random', 'ensemble', 'ensemble_total', 'lengths'],
        default='noskip'
    )
    group.add_argument(
        '--layermask-noisy',
...
Commit your changes first, then try again.''')
    ...
    if (args.action_type == 'translate' or args.action_type == 'probe_new_translate' or
            args.action_type == 'oracle_translate') and args.num_devices > 1:
