...
#SBATCH -o /mnt/nfs/work1/miyyer/simengsun/synst/experiments/01/output_train.txt
#SBATCH --mail-type=ALL
#SBATCH --mail-user=simengsun@cs.umass.edu

BASE_PATH=/mnt/nfs/work1/miyyer
PROJECT_PATH=$BASE_PATH/simengsun/synst
EXPERIMENT_PATH=$PROJECT_PATH/experiments/01
...
env $(cat ~/.comet.ml | xargs) python main.py --track -b 6000 --dataset iwslt_en_de --span 1 \
  --model new_transformer --attn-param 1 2 4 8 16 --attn-type normal --attn-position left --attn-displacement 1 \
  --dec-attn-param 1 --dec-attn-type learned --dec-attn-position center --dec-attn-displacement 1 \
