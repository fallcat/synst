#!/bin/bash
#
#SBATCH --job-name=eval-probe-transformer
...
CUDA_VISIBLE_DEVICES=0 python main.py --dataset iwslt_en_de --span 1 \
  --model probe_transformer --embedding-size 286 --hidden-dim 507 --num-heads 2 --num-layers 5 \
  -d /mnt/nfs/work1/miyyer/wyou/iwslt -p /mnt/nfs/work1/miyyer/wyou/iwslt \
  --split test -v \
  --restore /mnt/nfs/work1/miyyer/wyou/synst/experiments/iwslt01/checkpoint.pt \
  --average-checkpoints 5 probe_evaluate \
  --watch-directory /mnt/nfs/work1/miyyer/wyou/synst/experiments/iwslt01 --stats-directory /mnt/nfs/work1/miyyer/wyou/synst/experiments/iwslt01 
