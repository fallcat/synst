...
#SBTACH --exclude=node105
#SBATCH -o /mnt/nfs/work1/miyyer/wyou/synst/experiments/wmt15/output_eval.txt
...
CUDA_VISIBLE_DEVICES=0 python main.py --dataset wmt_en_de --span 1 \
  --model new_transformer --attn-param 1 --attn-type normal --attn-position left right --attn-weight 0  --attn-displacement 1 --embedding-size 512 --hidden-dim 2048 --num-heads 8 --num-layers 6 --attn-threshold 0.3 \
