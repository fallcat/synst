...
#SBATCH -o /mnt/nfs/work1/miyyer/wyou/synst/experiments/wmt07/output_eval.txt
#SBATCH --mail-type=ALL
#SBATCH --mail-user=wyou@cs.umass.edu

BASE_PATH=/mnt/nfs/work1/miyyer
PROJECT_PATH=$BASE_PATH/wyou/synst
EXPERIMENT_PATH=$PROJECT_PATH/experiments/wmt07
...
CUDA_VISIBLE_DEVICES=0 python main.py --dataset wmt_en_de --span 1 \
  --model new_transformer --attn-param 1 --attn-type normal normal normal normal learned learned learned learned --attn-position last --attn-displacement 1 --embedding-size 512 --hidden-dim 2048 --num-heads 8 --num-layers 6 \
