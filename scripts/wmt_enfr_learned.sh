#!/bin/bash
#
#SBATCH --job-name=wmt_enfr_learned
...
#SBATCH -o /mnt/nfs/work1/miyyer/simengsun/synst/experiments/wmt_enfr_learned/output_train.txt
...
env $(cat ~/.comet.ml | xargs) python main.py --track -b 3175 --dataset wmt_en_fr --span 1 \
  --model new_transformer --attn-type learned --dec-attn-type learned \
