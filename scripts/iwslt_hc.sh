...
#SBATCH -o /mnt/nfs/work1/miyyer/wyou/synst/experiments/iwslt02/output_train.txt
#SBATCH --mail-type=ALL
#SBATCH --mail-user=wyou@cs.umass.edu

BASE_PATH=/mnt/nfs/work1/miyyer
PROJECT_PATH=$BASE_PATH/wyou/synst
EXPERIMENT_PATH=$PROJECT_PATH/experiments/iwslt02
...
env $(cat ~/.comet.ml | xargs) python main.py --track -b 6000 --dataset iwslt_en_de --span 1 \
  --model new_transformer --attn-param 1 --attn-type normal --attn-position left right --attn-weights 0 --attn-displacement 1 \
  --dec-attn-param 1 --dec-attn-type normal --dec-attn-position left center --dec-attn-weights 0 --dec-attn-displacement 1 \
  --enc-dec-attn-param 1 --enc-dec-attn-type learned \
  --enc-dec-attn-weights 1 --enc-dec-attn-displacement 1 \
